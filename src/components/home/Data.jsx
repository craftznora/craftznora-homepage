...
const Data = () => {
  return (
    <div className="home__data">
        ...
        <h3 className="home__subtitle"> indie app developer</h3>
        <p className="home__description">Sathmin is a freelance and a full-stack developer based in Sri Lanka with a passion for building digital services/stuff he wants.He has a knack for all things launching products, from planning and designing all the way to solving real-life problems with code.</p>
