...
const Qualification = () => {
  ...
  return (
    <setion className="qualification section">
                ...
                <div className={toggleState === 1 ? "qualification__content qualification__content-active" : "qualification__content"}>
                    ...
                    <div className="qualification__data">
                        ...
                        <div>
                            ...
                            <span className="qualification__subtitle">MRC - Homagama</span>
                            <div className="qualification__calendar">
                    ...
                    <div className="qualification__data">
                        <div>
                            <h3 className="qualification__title">Studied education</h3>
                            <span className="qualification__subtitle">MRC - Homagama</span>
                            <div className="qualification__calendar">
                    ...
                    <div className="qualification__data">
                        ...
                        <div>
                            <h3 className="qualification__title">Scholarship Exam</h3>
                            <span className="qualification__subtitle">Subharathi College</span>
                            <div className="qualification__calendar">
                ...
                <div className={toggleState === 2 ? "qualification__content qualification__content-active" : "qualification__content"}>
                    ...
                    <div className="qualification__data">
                        <div>
                            ...
                            <span className="qualification__subtitle">The Code Base</span>
                            <div className="qualification__calendar">
